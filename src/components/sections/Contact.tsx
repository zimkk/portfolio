...
const Contact = ({ darkMode }) => {
  ...
  return (
    <section id="contact" className="py-20 px-6 md:px-12 lg:px-20 bg-black relative overflow-hidden">
      {/* Background Elements */}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <div className="bg-black/50 backdrop-blur-sm border border-gray-800/50 rounded-2xl p-8 hover:border-gray-600/50 transition-all duration-300">
          ...
          <div className="mt-16 text-center">
            <div className="bg-black/50 backdrop-blur-sm border border-gray-800/50 rounded-2xl p-8 max-w-4xl mx-auto">
